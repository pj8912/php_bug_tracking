...
<div class="container">
    ...
    <div class="mt-5 card card-body rounded-0 m-auto col-md-4">
        ...
        <form action="" method="post" class="mt-3">
            ...
            <div class="mb-2">
                <input type="text" class="form-control  rounded-0" placeholder="Role(s)">
            </div>
            <div class="mb-2">
                <input type="email" class="form-control  rounded-0" placeholder="Email Address">
            </div>
            <div class="mb-2">
                <input type="text" class="form-control  rounded-0" placeholder="Mobile Number">
            </div>
            <div class="d-grid gap-2">
                <button class="btn btn-success rounded-0 " name="ubtn">Submit</button>
            </div>
        </form>
    </div>
</div>
